...
// import genere from '../constant/GenerList'
     ...
     <div>
         <div className='flex flex-col justify-center items-center h-[300px] bg-[url("https://oxo.kz/templates/Moplay/images/01.jpg")] bg-no-repeat bg-center'>
            <div className='flex flex-col justify-center items-center h-full bg-black bg-opacity-80 w-full'>
               <h1 className=' text-white text-xl sm:text-4xl font-bold'>Welcome to Kaz Movie</h1>
               <p className='text-white text-[12px] mt-2 sm:text-xl'>You can buy new movies here</p>
               <button className='mt-4 px-6 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition duration-300'>Vibe group</button>
            </div>
         </div>
         ...
         <div className="overflow-hidden w-full mt-4">
             <div className="flex animate-scroll-right space-x-6 w-max">
               {[...testimonials.slice(0, 9), ...testimonials.slice(0, 9)].map((testimonial, index) => (
         ...
         <div className="overflow-hidden w-full mt-10">
           <div className="flex animate-scroll-left space-x-6 w-max">
             {[...testimonials.slice(9), ...testimonials.slice(9)].map((testimonial, index) => (
               <Card key={index} testimonial={testimonial} />
             ))}
           </div>
         </div>
         ...
         <div className='px-5 py-5 '>
            <div className="container px-5 py-5 w-[80%] mx-auto border-[var(--theme-color)] border-[1px] rounded-lg bg-[var(--theme-color)]">
                <h1 className="text-white text-4xl font-bold mb-4">Top Collected Movies by Views</h1>

                <div className='w-full flex flex-col gap-4'>

      {/* 1-ші қолданушы */}
      <div className="flex items-center gap-4 p-2 border-b">
        <img src={TopMovies[0].img} alt="Rodrigo Ceni" className="w-[40px] h-[40px] rounded-full" />
        <div className="flex-1">
          <h2 className="text-white text-md font-semibold">{TopMovies[0].title}</h2>
          <div className="flex items-center gap-2 mt-1">
            <div className="w-[90%] bg-gray-300 rounded-full h-2.5">
              <div className="bg-[var(--theme-color2)] h-2.5 rounded-full" style={{ width: "100%" }}></div>
            </div>
      ...
      {/* 2-ші қолданушы */}
      <div className="flex items-center gap-4 p-2 border-b">
        <img src={TopMovies[1].img} alt="Felipe" className="w-[40px] h-[40px] rounded-full" />
        <div className="flex-1">
          <h2 className="text-white text-md font-semibold">{TopMovies[1].title}</h2>
          <div className="flex items-center gap-2 mt-1">
            <div className="w-[90%] bg-gray-300 rounded-full h-2.5">
              <div className="bg-[var(--theme-color2)] h-2.5 rounded-full" style={{  width: "90.54%" }}></div>
            </div>
      ...
      {/* 3-ші қолданушы */}
      <div className="flex items-center gap-4 p-2 border-b">
        <img src={TopMovies[2].img} alt="enterpr1se" className="w-[40px] h-[40px] rounded-full" />
        <div className="flex-1">
          <h2 className="text-white text-md font-semibold">{TopMovies[2].title}</h2>
          <div className="flex items-center gap-2 mt-1">
            <div className="w-[90%] bg-gray-300 rounded-full h-2.5">
              <div className="bg-[var(--theme-color2)] h-2.5 rounded-full" style={{ width: "27.94%" }}></div>
            </div>
      ...
      <div className="flex items-center gap-4 p-2">
        <img src={TopMovies[3].img} alt="raze464" className="w-[40px] h-[40px] rounded-full" />
        <div className="flex-1">
          <h2 className="text-white text-md font-semibold">{TopMovies[3].title}</h2>
          <div className="flex items-center gap-2 mt-1">
            <div className="w-[90%] bg-gray-300 rounded-full h-2.5">
              <div className="bg-[var(--theme-color2)] h-2.5 rounded-full" style={{ width: "17%" }}></div>
            </div>
      ...
      <div className="flex items-center gap-4 p-2">
        <img src={TopMovies[4].img} alt="raze464" className="w-[40px] h-[40px] rounded-full" />
        <div className="flex-1">
          <h2 className="text-white text-md font-semibold">{TopMovies[4].title}</h2>
          <div className="flex items-center gap-2 mt-1">
            <div className="w-[90%] bg-gray-300 rounded-full h-2.5">
              <div className="bg-[var(--theme-color2)] h-2.5 rounded-full" style={{ width: "15.4%" }}></div>
            </div>
