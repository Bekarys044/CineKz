...
function Footer() {
  ...
  return (
    <footer className="mt-20 border-t py-20 bg-[var(--footer-bg)]">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 px-10">
              ...
              <div>
                    <div className="flex items-center flex-shrink-0 text-[var(--footerhover)]  text-2xl font-bold cursor-pointer">
                      ...
                      <div  className="text-[var(--footer-text-color)] text-sm mt-4">
              ...
              <ul>
                {resourcesLinks.map((link, index) => (
                  <li key={index} className="mb-2">
                    <a className="text-[var(--footer-text-color)] transition-[var(transition2)] hover:text-[var(--footerhover)]" href={link.href}>{link.text}</a>
                  </li>
                ))}
              </ul>
            </div>
